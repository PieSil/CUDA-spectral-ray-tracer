...
public:
	...
	__device__
	static void ray_bounce(const uint t_in_block_idx, bvh** bvh, bool do_something, ray& r, const float* background_emittance_spectrum, uint bounce_limit, hit_record* shared_hit_records, bvh_node * bvh_node_cache, curandState* local_rand_state);
